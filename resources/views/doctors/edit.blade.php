        ...
        <div class="container">
            ...
            <div class="d-flex flex-column gap-3 details-card doctor-details">
              ...
              <h6 class="card-title fw-bold">
                ...
                <hr />
                <form class="form" action="{{route('doctors.update', $id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-items">
                        ...
                        <div class="mb-3">
                            <label class="form-label required-label" for="phone">major</label>
                            <input type="tel" class="form-control" id="phone" name="major" required />
                        </div>
                        <div class="mb-3">
                            <label class="form-label required-label" for="discription">description</label>
